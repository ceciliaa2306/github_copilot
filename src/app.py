...
activities = {
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["oliver@mergington.edu", "isabella@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Science Club": {
        "description": "Conduct experiments and explore science through hands-on projects",
